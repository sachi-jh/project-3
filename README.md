...
Deployed Application (**required**): [Kudos Board Deployed Site](https://project-3-l48u.onrender.com/)
...
refactor the code to be a bit better, optimized and organized, plus more stretch features

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

The dark/light mode toggle is a bit advanced for me, would def love to implement something like that
